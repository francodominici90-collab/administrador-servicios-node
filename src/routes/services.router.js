...
servicesRouter.get("/:sid", async (req, res) => {
  try {
...
servicesRouter.put("/:sid", async (req, res) => {
  try {
    const { sid } = req.params;

    const updatedService =
      await serviceManager.updateService(sid, req.body);
...
servicesRouter.delete("/:sid", async (req, res) => {
  try {
    const { sid } = req.params;
